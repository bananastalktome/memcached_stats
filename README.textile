...
In the @new@ method, a third parameter (the @identifier@) can be specified, which serves as a way to identify the memcached instance in output. This is purely presentational, and defaults to the host if not provided.
